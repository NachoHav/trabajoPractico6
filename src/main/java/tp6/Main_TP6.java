...
public class Main_TP6 {
    ...
    public static void main(String[] args) {
        ...
        Cliente c1 = new Cliente("Ignacio", "Havelka", "Ayacucho 123", "San Luis", 266467728, 42909185);
        Cliente c2 = new Cliente("Fede", "Havelka", "Falucho 444", "Cordoba", 7777777, 12345678);
        ...
        agenda.buscarTelefono("Havelaka");
